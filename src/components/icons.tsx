...
// This Logo component is now the single source of truth for the app logo.
export const Logo = (props: Omit<React.ComponentProps<typeof Image>, 'src' | 'alt'>) => (
  <Image src="/logo512.png" alt="Fair Chain Logo" width={48} height={48} {...props} />
);

export const BrandIcon = (props: Omit<React.ComponentProps<typeof Image>, 'src' | 'alt'>) => (
   <Image src="/logo512.png" alt="Fair Chain Brand Icon" width={48} height={48} {...props} />
);
